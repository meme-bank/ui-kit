...
export const MessagePagePart: React.FC<React.PropsWithChildren<MessagePagePartProps>> = ({ type, title, close, children, icon }) => {
    ...
    const buttonClassName =
        type === "error" ? "ms:hover:bg-red-200 ms:text-red-800" :
            type === "success" ? "ms:hover:bg-green-200 ms:text-green-800" :
                type === "warning" ? "ms:hover:bg-yellow-200 ms:text-yellow-800" :
                    "ms:hover:bg-blue-200 ms:text-blue-800";
