...
const badgeVariants = cva(
  "ms-inline-flex ms-items-center ms-rounded-full ms-border ms-px-2.5 ms-py-0.5 ms-text-xs ms-font-semibold ms-transition-colors focus:ms-outline-none focus:ms-ring-2 focus:ms-ring-ring focus:ms-ring-offset-2",
  {
    variants: {
      variant: {
        default:
