  ...
  args: {
    children: (
      <p>
        ...
        consequuntur deserunt architecto blanditiis atque? Itaque, provident
        neque ipsam assumenda laudantium accusamus. Libero ex ratione quae
        corporis maxime saepe iure cum!
      </p>
    ),
  },
};
