            ...
            <DialogContent autoClose>
                <DialogHeader>
                    ...
                    <DialogDescription className="space-y-2">
                        <p>Для использования НБМ, требуется подключить Ваш аккаунт VK ID к Вашей учётной записи НБМ<sup className="text-muted-foreground">Sanctum</sup>. Это требуется для проверки подлинности учётной записи, а также для осуществления привязки государств и организаций к группам VK.</p>
